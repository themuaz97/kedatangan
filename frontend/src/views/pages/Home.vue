<template>
  <div class="flex justify-center flex-col items-center h-screen datepicker-wrapper">
    <h1>Home</h1>
    ...
    <Datepicker v-model="selectedDate" selectionMode="range" icon="pi pi-calendar" placeholder="Pick a date" />
